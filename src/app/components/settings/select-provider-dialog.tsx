...
export function SelectProviderDialog({
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center">
			...
			<div
				className="el-dialog relative z-10 flex w-full max-w-md flex-col overflow-hidden bg-background"
			...
			>
				...
				<div className="border-b border-[var(--separator)] px-5 py-3">
					<input
						...
						className="block w-full rounded-lg bg-surface px-3 py-2 text-sm text-foreground placeholder:text-placeholder shadow-[var(--shadow-inset)] outline-none transition-colors focus:border-accent"

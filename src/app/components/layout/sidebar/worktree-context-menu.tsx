import { DotsHorizontal, Reload, Trash } from "@openai/apps-sdk-ui/components/Icon"
...
/**
 * Context menu for worktree items in the sidebar.
 * Shows Reset and Remove actions.
 */
export function WorktreeContextMenu({ onRemove, onReset }: WorktreeContextMenuProps) {
			...
			{open &&
				...
				createPortal(
					...
					>
						...
						>
							<Reload className="h-3 w-3 text-muted" aria-hidden="true" />
							Reset
						</button>
						<button
							type="button"
